 ...
 * south-east - (W-1, H-1); south-west - (0, H-1). By default, a robot should be placed in the
 * north-west corner facing south direction. However, it should be also possible to give any
 * coordinates and direction as the initial robot location. Robot must not be able to get
