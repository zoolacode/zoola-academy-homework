 ...
 * files directly: to complete the task you can just print statements like “Opening
 * a file test.txt” or “Adding file details in CSV format” for each action. Try to
 * minimize duplicated code between classes (note, that in a real world multiple
 * statements might be needed to perform these tasks).
 */

public class Task4 {
    public static void main(String[] args) {
        Stream.of(new CsvReporter("csvHeaderData",
                                "csvFileData",
                                "csvFileName"),
                        new PdfReporter("pdfHeaderData",
                                "pdfFileData",
                                "pdfFileName"),
