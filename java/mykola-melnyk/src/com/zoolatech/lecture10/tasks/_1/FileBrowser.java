...
public class FileBrowser {
    ...
    public void loopOpen() throws IOException {
        try (FileOutputStream outputStream = new FileOutputStream("/home/x/IdeaProjects/zoola-academy-homework/java/mykola-melnyk/src/com/zoolatech/lecture9/tasks/_1/db/error.log", true);
