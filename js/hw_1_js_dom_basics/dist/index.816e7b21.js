...
const rules = {
    ...
    onOutsideActiveElementClick: ()=>{
        for (item of arrayOfElements)item.addEventListener("click", (e)=>{
    ...
    onActiveElementClick: ()=>{
        ...
        if (currentClick >= rules.negativeClick) currentScore -= rules.doubleClickPenalty;
        else if (currentClick === rules.positiveСlick) currentScore += rules.addingPointsInOneClick;
        scoreContainer.innerText = currentScore;
    }
};
/**
