...
import { snakeGrow } from "../../function/Snake/snakeGrow";
import { snakeBodyTail } from "../../function/Snake/snakeBodyTail";
import {
  getIsSnakeHeadOutsideBoard,
  getIsSnakeHeadOnBody,
  getIsTimeOut,
} from "../../function/GameOver/gameOver";
import { GetEat } from "../../function/Snake/GetEat";
...
const Board = () => {
  ...
  function snakeMove() {
      ...
      const hasEatenFood = GetEat(
        snakeBodyFirstElemMove,
        foodX,
        foodY
      );
      const snakeBody = snakeGrow(
        hasEatenFood,
        snakeBodyBefore,
        snakeBodyFirstElemMove,
    ...
    <div>
      <div className="mesh">
        ...
        <div className="mesh_action">
          {gameOver && (
            <div className="alert">
              <span>Game is over. Do you want to restart?</span>
            </div>
          )}
          {pause && (
            <div className="alert">
